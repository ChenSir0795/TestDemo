...
public class EnterScreen extends JFrame {
    ...
    public EnterScreen() { 
        ...
        setSize(700,790);//设计窗体的大小
        setTitle("请登录");
        setBackground(Color.red);//设置背景颜色
        JLabel a=new JLabel("username"); //实例化JLabel对象
        JLabel b=new JLabel("password");
        //JLabel g=new JLabel("忘记用户名/密码？");
       // JLabel h=new JLabel("验证码");
     //   g.setForeground(Color.BLUE); 
        JTextField c=new JTextField(10);//实例化用户名文本框
        JPasswordField d=new JPasswordField(10);//实例化密码框
       ...
       // g.setBounds(190,75,100,30);
        ...
        e.addActionListener(new ActionListener() {//对登录按钮添加监听事件
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if(c.getText().trim().equals("ChenSir")&&new String(d.getPassword()).equals("123456")&&s==1) {//equals函数进行用户名和密码的匹配
                    JOptionPane.showMessageDialog(null,"登录成功");
                    
                    new NewFrame();//进入到NewFrame这个窗体中
                }else if(c.getText().trim().equals("ChenSir")&&new String(d.getPassword()).equals("123456")&&s==0) {
...
//            if(k.getText()== null) {
//                s=0;
//            }else if(vcode.getClass() == null) {
//                s=1;
//            }else if(vcode.getClass() .equals(k.getText())) {
//                s=1;
//            }else { 
//            s=0;    
//        }
